...
function ViajesUsuarios() {
    ...
    return (
        <div className="fondopantalla p-1">
            ...
            <p className="alert alert-danger font-weight-bold viajes-us-p"><CgDanger className="mr-2" style={{ fontSize: 25 }} />Para reservar un pasajes tendrás que pagar un 25% del mismo</p>
