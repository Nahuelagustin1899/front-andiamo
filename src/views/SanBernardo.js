    ...
    return (
        <div className="fondopantalla p-5">
            ...
            <Card className="card-informacion">
                ...
                <Card.Body>San Bernardo es también mencionada como <b className="text-info">"La Perla de La Costa"</b> por ser el centro urbano con mayor movimiento comercial turístico del partido y por la belleza de la ciudad.
            </Card.Body>
