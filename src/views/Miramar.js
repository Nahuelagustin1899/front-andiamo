    ...
    return (
        <div className="fondopantalla p-5">
            ...
            <Card className="card-informacion">
                <Card.Body>Miramar es una ciudad costera argentina situada en el sudeste de la provincia de Buenos Aires. Es la cabecera del partido de General Alvarado y un importante centro turístico. Se encuentra a 48 km de Mar del Plata y a 448 km de la ciudad de Buenos Aires.
                </Card.Body>
                ...
                <Card.Body>Además la ciudad ofrece diferentes alternativas culturales, museos, teatros y fiestas populares, y ofertas educativas en todos los niveles de la enseñanza, como así también medios de comunicación que mantienen a los pobladores y turistas informados. 
                </Card.Body>
            </Card>
        </div>
    );
