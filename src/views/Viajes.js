    ...
    const lista = viajes.map(item => (
        <div key={item.id}>
            <Table variant="warning" striped bordered hover   >
                <thead>
                    <tr className="row">
                        <th className="col-4 text-center colorth radius">Salida</th>
                        <th className="col-4 text-center colorth">Llegada</th>
                        <th className="col-4 text-center colorth radius">Precio</th>
                    </tr>
                </thead>
                <tbody>
                    <tr className="row">
                        <td className="col-4 text-center colortd radius">{item.salida.nombre}</td>
                        <td className="col-4 text-center colortd">{item.destino.nombre}</td>
                        <td className="col-4 text-center colortd radius">$ {item.precio}</td>
                    </tr>
                </tbody>
            </Table>
            ...
            <Table variant="warning" striped bordered hover >
                <thead>
                    <tr className="row">
                        <th className="col-4 text-center colorth radius">Empresa</th>
                        <th className="col-4 text-center colorth">Fecha salida</th>
                        <th className="col-4 text-center colorth radius">Fecha llegada</th>
                    </tr>
                </thead>
                <tbody>
                    <tr className="row">
                        <td className="col-4 text-center colortd radius">{item.empresa.nombre}</td>
                        <td className="col-4 text-center colortd">{format(new Date
                            (item.fecha_salida), 'dd-MM-yyyy hh:mm:ss a')}</td>
                        <td className="col-4 text-center colortd radius">{format(new Date
