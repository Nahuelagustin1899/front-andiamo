...
const validateSchema = yup.object().shape({
    ...
    fecha_salida: yup.date().min(new Date(2021, 7, 16), "No puede elegir fechas pasadas").typeError('La fecha de salida no puede estar vacia'),
    fecha_llegada: yup.date().min(new Date(2021, 7, 16), "No puede elegir fechas pasadas").typeError('La fecha de llegada no puede estar vacia'), 
